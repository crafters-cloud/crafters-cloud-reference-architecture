...
exec { & dotnet test -c Release "$solutionDir/CraftersCloud.ReferenceArchitecture.sln" --no-build -l trx --verbosity=normal --filter "Category=integration|Category=unit" }
